...
The goal of HanaahRTidy is to make it easy to clean and organize your data in R. This package includes simple and useful tools that help you tidy up your data, so it's ready for analysis and visualization.
